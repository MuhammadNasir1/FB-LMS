                    ...
                    <div class="mt-5">
                        ...
                        <div class="mt-5">
                            <div class="flex justify-between mb-1">
                                <span class="text-base font-medium text-primary dark:text-white">Overall Competition</span>
                        ...
                        <p class="text-[#484747] pt-2 text-sm">09/07/2024</p>
                        <div class="mt-5">
                            <div class="flex justify-between mb-1">
                                <span class="text-base font-medium text-primary dark:text-white">Pending</span>
                                <span class="text-sm font-medium text-primary dark:text-white">65%</span>
                            </div>
                            <div class="w-full bg-gray rounded-full h-3 dark:bg-gray-700">
